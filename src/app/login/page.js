...
export const metadata = {
  title: "Login | The Organic Editorial",
  description: "Sign in to your Bharat Bazaar Fresh account",
};
      ...
      <main className="grow flex items-center justify-center p-6 relative overflow-hidden min-h-screen">
        ...
        <div className="w-full max-w-md z-10">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-primary brand-font italic">
              The Organic Editorial
            </h1>
            <p className="text-on-surface-variant mt-2 font-medium">
              Welcome to Bharat Bazaar Fresh
            </p>
          </div>
